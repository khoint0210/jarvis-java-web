                                ...
                                <div class="block margin-bottom-sm">
                                    ...
                                    <div class="table-responsive">
                                        <c:if test="${not empty requestScope.DTO.avatar}">
                                            <div class="avatar">
                                                <center>
                                                    <img src="${requestScope.DTO.avatar}" alt="..." class="img-fluid rounded-circle" width="320px" height="320px">
                                                </center>
                                            </div>
                                        </c:if>
                                        <div class="col-lg-12">
                                            <div class="block">
                                                <center>
                                                    <form action="MainController" method="post" enctype="multipart/form-data">
                                                        <input name="Upload Equipment Avatar" type="file" required>
                                                        <input type="submit" value="Upload Equipment Avatar" name="${requestScope.DTO.ID}" class="btn btn-secondary"/>
                                                    </form>
                                                </center>
                                                <div class="title">
                                                    <br>
                                                    <strong>ID : ${requestScope.DTO.ID}</strong>
                                                </div>
                                                <div class="block-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" value="${requestScope.DTO.name}" disabled>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" value="${requestScope.DTO.owner}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 form-control-label">Description</label>
                                                        <div class="col-sm-9">
                                                            <textarea rows="4" cols="50" class="form-control" disabled>${requestScope.DTO.description}
                                                            </textarea>
                                                        </div>
                                                    </div>
                                                    <div class="line"></div>
                                                    <div class="form-group row">
                                                        <div class="col-sm-9 ml-auto">
                                                            <button type="submit" class="btn btn-secondary" value="Back Equipment" name="action">Back Equipment</button>
