                                                ...
                                                <div class="block-body">
                                                    <form class="form-horizontal">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" required value="" name="txtUsername" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" required name="txtFullname" value="">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" required name="txtMadeUpName" value="">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" required name="txtRole" value="" pattern="^root$|^user$|^admin$" title="root, admin and user only">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="number" min="1" class="form-control" required name="txtAge" value="">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <textarea maxlength="450" rows="4" cols="50" name="txtDrawBack" class="form-control" required></textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-9 ml-auto">
                                                                <button type="submit" class="btn btn-primary" value="Insert Avenger" name="action">Insert Avenger</button>
