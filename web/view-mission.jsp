                                                ...
                                                <div class="block-body">
                                                    ...
                                                    <form class="form-horizontal">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" disabled class="form-control" required value="${requestScope.MISSION_INFO.name}" name="txtMissionName" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="datetime-local" disabled class="form-control" name="txtStartDate" required value="${requestScope.MISSION_INFO.startDate}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="datetime-local" disabled class="form-control" required  name="txtEndDate" value="${requestScope.MISSION_INFO.endDate}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" required disabled name="txtLocation" value="${requestScope.MISSION_INFO.location}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <c:if test="${requestScope.MISSION_INFO.complete == 0}">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" disabled class="form-control" required name="txtEndDate" value="This mission is not done">
                                                                </div>
                                                            </div>
                                                        </c:if>
                                                        <c:if test="${requestScope.MISSION_INFO.complete == 1}">
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 form-control-label">Status : </label>
                                                                <div class="col-sm-9">
                                                                    <input type="text" disabled class="form-control" required name="txtEndDate" value="This mission is done">
                                                                </div>
                                                            </div>
                                                        </c:if>
                                                        <br>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <c:if test="${List != null}">
                                                                ...
                                                                <c:if test="${!check}">
                                                                    <label class="col-sm-8 form-control-label">NO ONE IN THIS MISSION</label>
                                                                </c:if>
                                                            </c:if>
                                                        </div>
                                                            ...
                                                            <div class="col-sm-9 ml-auto">
                                                                <c:if test="${fn:contains(sessionScope.ROLE, 'root')}">
                                                                    <form action="MainController" method="POST">
                                                                        <button type="submit" class="btn btn-secondary" value="Back Mission" name="action">Back Misson</button>
                                                                        <input type="hidden" name="txtSearchMission" value="${param.txtSearchMission}" />
                                                                    </form>
                                                                </c:if>
                                                                <c:if test="${fn:contains(sessionScope.ROLE, 'user') || fn:contains(sessionScope.ROLE, 'admin')}">
                                                                    <form action="MainController" method="POST">
                                                                        <c:if test="${requestScope.MISSION_INFO.complete == 0}">
                                                                            <div>Tick this if you done
                                                                                <input type="checkbox" name="missionStatus" value="1" />
                                                                            </div>
                                                                            <br>
                                                                            <button type="submit" class="btn btn-secondary" value="Update Status Mission" name="action">Update Mission Status</button>
                                                                        </c:if>
                                                                        <button type="submit" class="btn btn-secondary" value="Back Mission User" name="action">Back Misson</button>
