                            ...
                            <div class="col-lg-12">
                                <div class="block margin-bottom-sm">
                                    ...
                                    <div class="table-responsive">
                                        <c:if test="${not empty requestScope.EQUIPMENT_INFO.avatar}">
                                            <div class="avatar">
                                                <center>
                                                    <img src="${requestScope.EQUIPMENT_INFO.avatar}" alt="..." class="img-fluid rounded-circle" width="320px" height="320px">
                                                </center>
                                            </div>
                                        </c:if>
                                        <div class="col-lg-12">
                                            <div class="block">
                                                <div class="title">
                                                    <br>
                                                    <strong>ID : ${requestScope.EQUIPMENT_INFO.ID}</strong>
                                                </div>
                                                <div class="block-body">
                                                    ...
                                                    <form action="MainController" method="POST" class="form-horizontal">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" name="txtEquipmentName" class="form-control" value="${requestScope.EQUIPMENT_INFO.name}" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <textarea name="txtDescription" rows="4" cols="50" class="form-control" maxlength="450" required>${requestScope.EQUIPMENT_INFO.description}
                                                                </textarea>
                                                            </div>
                                                        </div>
                                                        <div class="line"></div>
                                                        <div class="form-group row">
                                                            <div class="col-sm-9 ml-auto">
                                                                <button type="submit" class="btn btn-primary" value="Edit Equipment" name="action">Edit Equipment</button>
