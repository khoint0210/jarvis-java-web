...
<html>
  ...
  <img src="img/avatar-6.jpg" alt="..." class="img-fluid rounded-circle">
                ...
                <ul class="list-unstyled">
                    <li>
                        <c:url var="MissionNotification" value="MainController">
                            <c:param name="txtAvengerID" value="${sessionScope.ID}" />
                            <c:param name="action" value="Mission Notification" />
                        </c:url>
                        <a href="${MissionNotification}">
                            <i class="icon-home"></i>Mission Notification
                        </a>
                    </li>
            </nav>
                                                ...
                                                <div class="block-body">
                                                    <form class="form-horizontal">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <textarea rows="4" cols="50" class="form-control" disabled>${requestScope.AVENGER_INFO.drawback}</textarea>
                                                            </div>
                                                        </div>
