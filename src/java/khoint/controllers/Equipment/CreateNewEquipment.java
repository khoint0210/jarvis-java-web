 ...
 * @author khoint0210
 */
public class CreateNewEquipment extends HttpServlet {

    private static final String ERROR = "error.jsp";
    private static final String INSERT = "insert-equipment.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action.equals("Insert New Equipment")) {
                List<AvengersDTO> result = bean.getAllAvengers();
                request.setAttribute("AVENGER_LIST", result);
                url = INSERT;
            } else if (action.equals("Insert Equipment")) {
                ...
                EquipmentsDTO equipmentsDTO = new EquipmentsDTO(avengerID, name, description);
                bean.setEquipment(equipmentsDTO);
                if (bean.insertNewEquipment()) {
                    url = SUCCESS;
                } else {
