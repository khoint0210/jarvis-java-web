 ...
 * @author khoint0210
 */
public class CheckAvengerStatus extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int check = bean.checkAvengerFreeOrNot();
            request.setAttribute("AVENGER_STATUS", check);
        } catch (Exception e) {
            log("Error at CheckAvengerStatus : " + e.toString());
        } finally {
