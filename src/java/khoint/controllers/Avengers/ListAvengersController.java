 ...
 * @author khoint0210
 */
public class ListAvengersController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<AvengersDTO> results = bean.getAllAvengers();
            request.setAttribute("RESULT", results);
        } catch (Exception e) {
            log("Error at log ListAvengerControllers : " + e.getMessage());
        } finally {
